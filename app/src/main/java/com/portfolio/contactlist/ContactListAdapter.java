...
public abstract class ContactListAdapter extends RecyclerView.Adapter<ContactListAdapter.ViewHolder>
{
...
//                Toast.makeText(activityContext, "Long click success", Toast.LENGTH_SHORT).show();
    ...
    public abstract void onClicktoUpdate(int pos);
}